...
The connected node rebuild exposed unlocked transitive resolution drift for Mermaid11.16.0
...
materialised on the connected node after the comparison; explicit rebuild verification is recorded
