...
# of prompting a per-directory login under `dsp`.
...
# dsp follows [claude_code].permission_mode (ADR-2116, default bypassPermissions,
# projected into settings.json at boot); dspa / dspb force auto / bypass.
alias dsp="claude"
