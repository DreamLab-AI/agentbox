...
#     immediate, visible launch failure. "Correct" means a real URL parse of
#     scheme, host and port (config/harness-wrappers/_provider-url.sh), not a
#     hostname substring match — see ADR-2007.
#
