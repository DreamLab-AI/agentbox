...
unchanged. Read hp-qwen.md for transport, multimodal qualification and cleanup.
...
Use assets/prompts/qwen-system.txt as the stable instruction prefix. Use
qwen-section.txt for the section request and qwen-review.txt for a subsequent review.
