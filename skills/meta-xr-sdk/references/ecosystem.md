# Meta XR SDK — Ecosystem Reference

Full inventory of Meta's VR/AR developer ecosystem: WebXR toolkits, native
spatial SDKs, platform integration, device tooling, and agentic skills. The
lean guide (`../SKILL.md`) points here for catalogs, parameter tables, and
long examples.
