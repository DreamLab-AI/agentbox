...
## Freshness
Built from: 1.58M lines Rust, 2,535 .rs files, 113 crates, 56 npm packages, 30 WASM builds, 131 ADRs, 42 examples, 170 npm exports (2026-03-30 snapshot against commit `ff5acfb2`) — see [../BENCHMARK-RESULTS.md](../BENCHMARK-RESULTS.md) for the current freshness/qualification status; this directory (now README.md-reported as v3.5.0) has moved on since this snapshot was taken.
