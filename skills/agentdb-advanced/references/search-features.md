# Search Features — Distance Metrics, Hybrid Search, MMR, Context Synthesis
...
### Troubleshooting: Hybrid search returns no results
...
### Troubleshooting: Memory consolidation too aggressive
