...
Use these as starting templates for Codex task prompts or other Codex/GPT-6 Astra prompt construction.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Codex or GPT-6 Astra.
</task>
