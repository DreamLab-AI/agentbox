# Codex / GPT-6 Astra Prompting

Reference guidance for composing Codex and GPT-6 Astra (`gpt-6-astra`) prompts for coding,
review, diagnosis, and research tasks. Consulted by the `codex-rescue` subagent and by
anyone composing a `codex exec` prompt by hand (see
[../codex-exec-recipe.md](../codex-exec-recipe.md)).
