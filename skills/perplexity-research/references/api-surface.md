# Perplexity Three-API Surface — Full Reference

Complete parameter tables, code, and cookbook for the Perplexity platform
(May 2025 contracts). SKILL.md carries the quick-path; this file carries the detail.
...
Returns structured results with title, URL, snippet, and dates. Supports domain
filters, date filters, country, recency, and language.
...
Standard OpenAI-compatible chat endpoint. Still supported but Search + Agent APIs
are preferred for new work.
...
## Cookbook: Academic Reference Mining
...
For structured academic metadata (DOI, authors, abstract), prefer the `web-researcher`
skill's `academic_search` tool which queries arXiv, PubMed, IEEE, Nature, and Springer
APIs directly.

---

## Cookbook: UK Ecology and BNG Research
