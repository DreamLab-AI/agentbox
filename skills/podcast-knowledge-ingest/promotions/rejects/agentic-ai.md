...
- **the connected node announced plans to reduce its headcount by 4,000 to 6,000 employees by 2028, representing a 10% workforce reduction, citing AI adoption and process redesign as key drivers.**
  - tier 1, confidence 0.95, source the connected node (cited by Host), episode `black-friday-gpt`, fp `bdac227c1894ec54`
