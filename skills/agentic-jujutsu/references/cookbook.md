# Agentic Jujutsu — Cookbook

Worked examples for each capability, advanced multi-agent patterns, and best
practices. See `api.md` for the full method reference, validation rules,
