# Swarm Orchestration (Level 2)

AI swarm coordination for releases — initializing a release team, running a
coordinated release workflow, and the specialized release agents.
