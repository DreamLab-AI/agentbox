...
pub const CHANGELOG: &[ChangelogEntry] = &[
    ChangelogEntry {
        ...
        notes: &[
            ...
            "The UK-English rule is no longer implemented here at all. `us-spelling` is a positional marker in the table and the check is delegated to prose-sanitiser-uk's VarCon-backed checker, which adds the sense-dependent `us-spelling-sense` rule alongside it. The old flat alternation flagged `meter`, `licence`, `program`, `dialog` and `World Health Organization`; none of them now produce a mechanical replacement.",
