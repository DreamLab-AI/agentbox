...
pub fn render(s: &Value) -> String {
    ...
    push(
        ...
        vec![
            ...
            "implementation    = \"codex:gpt-6-astra -> claude:claude-fable-5-1\"".into(),
            "testing           = \"codex:gpt-6-astra -> claude:claude-opus-5\"".into(),
            "review            = \"claude:claude-sonnet-5\"".into(),
            "security-scan     = \"codex:gpt-6-astra\"".into(),
            "security-analysis = \"claude:claude-fable-5-1\"".into(),
            "documentation     = \"codex:gpt-6-astra\"".into(),
            "debugging         = \"claude:claude-fable-5-1\"".into(),
            "packaging         = \"codex:gpt-6-astra\"".into(),
