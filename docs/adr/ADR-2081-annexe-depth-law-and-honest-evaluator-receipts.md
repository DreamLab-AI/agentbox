...
Retain **accepted / complete / staged** for this source-and-local-test scope. The supervised Nix-store process, rebuilt image, actual HP annexe layout and live evaluator receipts were not inspected or exercised. The original rebuild/activation acceptance remains required.
