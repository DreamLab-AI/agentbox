...
| [ADR-2112](ADR-2112-dream-candidate-diffs-against-engine-read-source.md) | Dream candidate diffs are written against source the engine reads from the dispatched commit | GOVERNANCE-capabilities | 2026-09-25 | accepted | complete | staged | — | — | jjohare | agentbox |
| [ADR-2113](ADR-2113-dream-decisions-surface-on-the-forum-governance-panel.md) | Dream-machine decisions surface on the forum governance panel, and the nightly digest reports every outcome | — | 2026-09-25 | accepted | complete | staged | — | — | jjohare | agentbox |
