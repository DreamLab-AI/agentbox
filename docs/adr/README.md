...
| [ADR-2096](ADR-2096-sidestr-sidechains-are-the-sole-value-instrument.md) | Our own sidestr sidechains are the sole value instrument, built clean-room in Rust with rust-bitcoin accepted | BASELINE-container | 2026-09-21 | proposed | partial | inactive | — | — | jjohare | agentbox |
...
| [ADR-2103](ADR-2103-parent-chain-and-header-profile-are-configuration-behind-the-p21-gate.md) | The parent network and header profile are manifest configuration exposed by onboarding, bound into the chain document at genesis, with mainnet variants behind an implemented owner-and-legal gate | BASELINE-container | 2026-09-21 | proposed | partial | inactive | — | — | jjohare | agentbox |
...
| [ADR-2106](ADR-2106-sidestr-crates-are-agpl-derivatives-of-siding-published-and-consumed.md) | The sidestr Rust crates are AGPL-3.0-only derivatives of upstream siding, attributed, published to crates.io and consumed by the estate | BASELINE-container | 2026-09-22 | accepted | complete | live | — | — | jjohare | agentbox |
...
| [ADR-2110](ADR-2110-routing-teacher-labels-from-main-model-use.md) | Learn skill routing from the skills the main model actually uses, recorded as local embeddings | LEARNING-memory | 2026-09-23 | proposed | partial | inactive | — | — | jjohare | agentbox |
| [ADR-2111](ADR-2111-govern-the-claude-code-session-prefix-and-per-turn-context.md) | Govern the Claude Code session prefix and per-turn context | GOVERNANCE-capabilities | 2026-09-25 | accepted | complete | staged | — | — | jjohare | agentbox |
...
| [ADR-2116](ADR-2116-claude-code-permission-posture-from-the-manifest.md) | Project the Claude Code permission posture from the manifest, bypass by default with a deny floor | GOVERNANCE-capabilities | 2026-09-25 | accepted | complete | staged | — | — | jjohare | agentbox |
