...
| Precedent removal | **done** | The namespace was empty and nothing called the tools, so there was no migration to stay revertible. Files, gate, registration, hub entry and catalogue row all removed; 81 suites / 1297 tests still pass. |
