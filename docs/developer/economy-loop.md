...
- [`docs/developer/identity-mesh.md`](identity-mesh.md) — the five `did:nostr`
  ...
  code-as-harness).
- [`docs/archive/adr/ADR-005-pluggable-adapter-architecture.md`](../archive/adr/ADR-005-pluggable-adapter-architecture.md)
  — the pods slot contract.
- [`docs/archive/adr/ADR-013-canonical-uri-grammar.md`](../archive/adr/ADR-013-canonical-uri-grammar.md)
